...
const Sidebar = () => {
    ...
    const navigation=[
        ...
        
        {
            href: 'javascript:void(0)',
            name:'Group chat',
            icon:<button onClick={()=>{setdata(3)}}><HiMiniUserGroup className="text-black text-xl"/></button>
        ,
        },
        {
            href: 'javascript:void(0)',
            name:'Video Calling',
            icon:<button onClick={()=>{setdata(3)}}><IoIosVideocam className="text-black text-xl"/></button>
        ,
        },
        {
            href: 'javascript:void(0)',
        ...
        },
        {
            href: 'javascript:void(0)',
            name:'Suggestions',
            icon:<button onClick={()=>{setdata(3)}}><MdPersonSearch className="text-black text-xl"/></button>
        ,
        }
    ]
